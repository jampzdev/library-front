(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~add-user-add-user-module~edit-user-edit-user-module~list-user-list-user-module"],{
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.post = function (path, body, params) {
        ...
        if (params === void 0) { params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"](); }
        return this.httpClient
            .post(API_URL + path, JSON.stringify(body), { params: params, observe: 'response' })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.formatErrors));
    };
...
//# sourceMappingURL=default~add-user-add-user-module~edit-user-edit-user-module~list-user-list-user-module.js.map